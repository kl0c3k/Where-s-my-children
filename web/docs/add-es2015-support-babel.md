...
This recipe focuses on adding an ES2015 to ES5 transpile step to Multiplatform App (Android/WWW (iOS next))'s build pipeline using [BabelJS](https://babeljs.io/).
